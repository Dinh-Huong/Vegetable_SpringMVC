...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 pb-5">
				<f:form action="" class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="post" modelAttribute="customer">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter name">
						<f:input path="name" class="input100" type="text"  value="${ !empty name ? name : '' }" name="name" placeholder="Name"/>
						<span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter email">
						<f:input path="email" class="input100" type="text"  value="${ !empty email ? email : '' }" name="email" placeholder="Email"/>
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Please enter password">
						<f:input path="password" class="input100" type="password" value="${ !empty password ? password : '' }" name="password" placeholder="Password"/>
						<span class="focus-input100"></span>
					</div>
