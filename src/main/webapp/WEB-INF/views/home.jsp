...
<link href="${ contextPath }/user/lib/lightbox/css/lightbox.min.css"
	rel="stylesheet">
<link
	href="${ contextPath }/user/lib/owlcarousel/assets/owl.carousel.min.css"
	rel="stylesheet">


<!-- Customized Bootstrap Stylesheet -->
<link href="${ contextPath }/user/css/bootstrap.min.css"
	rel="stylesheet">

<!-- Template Stylesheet -->
<link href="${ contextPath }/user/css/style.css" rel="stylesheet">
<script src="${ contextPath }/user/js/index.js"></script>
</head>
...
<body>
	...
	<div class="container-fluid fixed-top">
		...
		<div class="container px-0">
			<nav class="navbar navbar-light bg-white navbar-expand-xl d-flex">
				...
				<div class="collapse navbar-collapse bg-white" id="navbarCollapse">
					<div class="navbar-nav mx-auto">
						...
						<a href="${ contextPath }/fruits" class="nav-item nav-link">Fruits
							Shop</a> <a href="${ contextPath }/vegetables"
							class="nav-item nav-link">Vegetable Shop</a> <a
							href="${ contextPath }/contact" class="nav-item nav-link">Contact</a>
					</div>
					<div class="d-flex m-3 me-0 align-items-center">
						...
						<%-- <a href="${ contextPath }/login" class="my-auto"> <i
							class="fas fa-user fa-2x"></i>
						</a>  --%>

						<div class="dropdown ml-0 mb-0 text-left">
							<a href="#"
							...
							<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
								...
								<li><a class="dropdown-item" href="${ contextPath }/information">Information</a></li>
	...
	<c:if test="${ !empty page }">
		<jsp:include page="web/${ page }.jsp"></jsp:include>
	</c:if>
	...
	<script src="${ contextPath }/user/lib/easing/easing.min.js"></script>
	<script src="${ contextPath }/user/lib/waypoints/waypoints.min.js"></script>
	<script src="${ contextPath }/user/lib/lightbox/js/lightbox.min.js"></script>
	<script src="${ contextPath }/user/lib/owlcarousel/owl.carousel.min.js"></script>

	<!-- Template Javascript -->
	<script src="${ contextPath }/user/js/main.js"></script>
</body>
