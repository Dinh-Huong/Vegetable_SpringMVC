				...
				<div class="row justify-content-between d-flex">
					<div class="col-6 p-3 shadow">
						<div class="d-flex justify-content-between align-items-center">
							...
							<a href="${ contextPath }/admin/accountAdmin/add" class="btn btn-success ml-3">Add account</a>
						</div>
							...
							<tbody>
								<c:forEach items="${ paginate.data }" var="order" varStatus="loop">
									<tr>
										...
										<td class="d-flex">
											<a href="${ contextPath }/admin/account/edit/${cate.id}"
											class="btn btn-info mr-3">Edit</a> 
											<a href="${ contextPath }/admin/account/delete/${cate.id}"
