...
<f:form action="${ contextPath }/admin/product/update" method="post" modelAttribute="product" cssClass="forms-sample" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<f:input path="thumbnail" cssClass="d-none"/>
		...
		<div class="w-100 mt-2 text-center">
			<img alt="" id="preview-img"  class="w-50" src="${ contextPath }/${product.thumbnail}">
		</div>
		<div class="form-group">
